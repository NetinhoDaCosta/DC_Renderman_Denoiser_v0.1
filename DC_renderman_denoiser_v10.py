...
print("Initializing DC Renderman Denoiser v0.1...")
...
class Mainwindow(qtw.QMainWindow):
    ...
    def selectRender(self):
        ...
        # print("Your render sequence path is: : " + first_filepath_itemUrl)
    ...
    def denoiseRender(self):
        ...
        for render_item in self.mijn_sequences:
            print("Current render sequence is: " + str(render_item))
            for render_file in render_item:
                clean_render_file = render_file.replace("/", "\\")
                print("++++++++++++++++++++++++++ Denoising the following frame: " +  str(clean_render_file) + " ++++++++++++++++++++++++++"   )
                batch_command = final_denoise_command + " " + clean_render_file
                print("Current command line statement: " + batch_command)

                subprocess.check_output(batch_command, shell=True)
                print("File: " +  str(clean_render_file) + " has been denoised successfully!")
